          ...
          <div>
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
              ...
              <div className="flex flex-wrap gap-2 mb-4 md:mb-0">
                {appliedFilter.map((selectedFilter) => (
                  <div
                    key={selectedFilter}
                    className="relative inline-flex items-center max-w-full"
                  >
                    <Badge
                      className="bg-yellow-300 hover:bg-yellow-200 active:bg-yellow-400 text-black shadow-md transition duration-200 transform hover:scale-105 active:scale-95 fade-in rounded-md hover:cursor-pointer pr-6 whitespace-nowrap"
                      variant="outline"
                    >
                      {selectedFilter}
                    </Badge>
                    <X
                      ...
                      size={16}
                      className="absolute text-black right-1 hover:cursor-pointer"
                      aria-label={`Remove ${selectedFilter}`}
                    />
                  </div>
                ))}
              </div>
                ...
                searchedRestaurant?.data.map((restaurant: Restaurant) => (
                  ...
                  >
                    ...
                    <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                      <Link to={`/restaurant/${restaurant._id}`} className="inline-block">
                        <Button className="text-black bg-yellow-300 hover:bg-yellow-200 active:bg-yellow-400 shadow-md transition duration-200 transform hover:scale-105 active:scale-95 fade-in rounded-md hover:cursor-pointer">
                          View Menu
                        </Button>
                      </Link>
                    </CardFooter>
